...
top_7_rc_class <- draft_cycle |>
  ...
  kable(top_7_rc_class, caption = "Top 7 rookie contract classes by rc_class_value from 2014-2020")
```
```{r}
top_7_rc_stats <- top_7_rc_class |>
  summarize(
...
kable(top_7_rc_stats, caption = "Top 7 rookie contract classes success statistics")
```
