...
top_10_rc_class <- draft_cycle |>
  ...
  kable(top_10_rc_class, caption = "Top 2 rookie contract classes by   rc_class_value from 2014-2020")
```
```{r}
top_10_rc_class |>
  summarize(
  ...
  kable(caption = "Top 2 rookie contract classes by   rc_class_value from 2014-2020")
```
```
